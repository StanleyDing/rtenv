...
void _write(struct task_control_block *task,
        struct task_control_block *tasks, size_t task_count,
...
int fifo_readable (struct pipe_ringbuffer *pipe,
...
int mq_readable (struct pipe_ringbuffer *pipe,
        struct task_control_block *task)
{
    size_t msg_len;
...
int fifo_read (struct pipe_ringbuffer *pipe,
        struct task_control_block *task)
{
    size_t i;
...
int mq_read (struct pipe_ringbuffer *pipe,
        struct task_control_block *task)
{
    size_t msg_len;
    size_t i;
...
int fifo_writable (struct pipe_ringbuffer *pipe,
        struct task_control_block *task)
{
...
int mq_writable (struct pipe_ringbuffer *pipe,
        struct task_control_block *task)
{
...
int fifo_write (struct pipe_ringbuffer *pipe,
        struct task_control_block *task)
{
    size_t i;
...
int mq_write (struct pipe_ringbuffer *pipe,
        struct task_control_block *task)
{
    size_t i;
    const char *buf = (const char*)task->stack->r1;
